...
async def inject_to_viewer(ws_url: str) -> Any:
    ...
    try:
        ...
        logger.error("[inject] Failed to find jszip.js: %s", e)
        return False
    except (PermissionError, IOError) as e:
        logger.error("[inject] Failed to read jszip.js: %s", e)
        return False
    ...
    try:
        ...
        logger.error("[inject] Failed to find inject.js: %s", e)
        return False
    except (PermissionError, IOError) as e:
        logger.error("[inject] Failed to read inject.js: %s", e)
        return False
